...
var (
	internalEchoPacket Packet = &pkt1len{ECHO_RES, 13, []byte{'i', 'n', 't', 'e', 'r', 'n', 'a', 'l', ' ', 'e', 'c', 'h', 'o'}}
	emptyEchoPacket    Packet = &pkt1len{ECHO_REQ, 0, []byte{}}
	resetAbilities     Packet = &pkt0size{RESET_ABILITIES}
	noop               Packet = &pkt0size{NOOP}
	noJob              Packet = &pkt0size{NO_JOB}
	grabJob            Packet = &pkt0size{GRAB_JOB}
	grabJobUniq        Packet = &pkt0size{GRAB_JOB_UNIQ}
	preSleep           Packet = &pkt0size{PRE_SLEEP}
)
